...
//
		/*
		function q=new ComplexFunction().initFromString("Divid(Plus(3.1+2.4x^2-1.0x^4,5.0-1.2999999999999998x+0.1x^5),3.1+2.4x^2-1.0x^4)");
		...
		*/
		...
		function xxxx=new ComplexFunction().initFromString("Min(Min(Min(Min(Plus(3.1+2.4x^2-1.0x^4,5.0-1.2999999999999998x+0.1x^5),Plus(Divid(1.0+1.0x,Times(Times(3.0+1.0x,-2.0+1.0x),-4.0+1.0x)),2.0)),Divid(Plus(3.1+2.4x^2-1.0x^4,5.0-1.2999999999999998x+0.1x^5),3.1+2.4x^2-1.0x^4)),3.1+2.4x^2-1.0x^4),5.0-1.2999999999999998x+0.1x^5)");
