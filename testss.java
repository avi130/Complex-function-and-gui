...
//		System.out.println(aa);
	//	function x=new ComplexFunction().initFromString("div(1.0x+1.0,mul(mul(1.0x+3.0,1.0x-2.0),1.0x-4.0))");
		function xx=new ComplexFunction().initFromString("divid(-1.0x^4 +2.4x^2 +3.1,plus(-1.0x^4 +2.4x^2 +3.1,+0.1x^5 -1.2999999999999998x +5.0))");
		function xxx=new ComplexFunction().initFromString("divid(plus(-1.0x^4 +2.4x^2 +3.1,+0.1x^5 -1.2999999999999998x +5.0),-1.0x^4 +2.4x^2 +3.1)");
